...
```Teknoloji :
  ...
  3- Kullanici yetkisi admin / standart seklinde farkli 2 tipte kullanici tanimlanabilecek bir tablo yapisi 
  VT uzerinde olusturulacaktir.
  ...
  * Menu-4 : Raporlar
  ...
  Tanri kullanici (username = root olan kullanici) silinemeyecek veya sifresi guncellenemeyecektir.
