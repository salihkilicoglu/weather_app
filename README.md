...
live version : http://salih55.pythonanywhere.com

Bu proje bana verilen bir teknik task'ın yapılmış halidir, teknik task şu şekilde:
...
```Teknoloji :
  ...
  1- MySQL/Postgresql  veritabani (VT) yonetim sistemi kullanarak calisacak dinamik bir hava durumu uygulamasi gelistirmesi beklenmektedir.
  ...
  * sorgulayan kullanici id - sorgulama zamani - sorgulama yapilan lokasyon id - sorgulama yapan kullanici ip adresi - sorgulama sonucu - sorgulama sonuc getirme suresi (mili saniye cinsinden) - sorgulama durumu (BASARILI / BASARISIZ)
